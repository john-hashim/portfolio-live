export const siteConfig = {
  ...
  aboutMe:
    "A full-stack engineer with 4+ years of experience building scalable web apps. As Lead Front-End Engineer at TeamWave, I led the migration to Angular 17 and built enterprise products from an e-signature module to a high-performance CRM with NgRx, PrimeNG, and AG Grid. More recently I designed and architected Chatvio, a full-stack AI chatbot platform — RAG-based retrieval, LLM-driven actions, and in-chat booking, built on React 19, Express, and PostgreSQL. I work mainly in React and Angular with TypeScript, and I'm currently open to front-end and full-stack roles.",
  skills: [
    "React",
    "TypeScript",
    "JavaScript",
